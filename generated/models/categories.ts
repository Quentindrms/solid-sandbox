...
export type categoriesWhereInput = {
  ...
  categorie_id?: Prisma.IntFilter<"categories"> | number
...
export type categoriesScalarWhereWithAggregatesInput = {
  ...
  categorie_id?: Prisma.IntWithAggregatesFilter<"categories"> | number
...
export type categoriesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"categorie_id" | "nom_categorie" | "description", ExtArgs["result"]["categories"]>
...
export interface categoriesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const categoriesWithCategorie_idOnly = await prisma.categories.findMany({ select: { categorie_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Categories and only return the `categorie_id`
   * const categoriesWithCategorie_idOnly = await prisma.categories.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Categories and only return the `categorie_id`
   * const categoriesWithCategorie_idOnly = await prisma.categories.updateManyAndReturn({
   *   select: { categorie_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface categoriesFieldRefs {
  readonly categorie_id: Prisma.FieldRef<"categories", 'Int'>
